...
n_eggs_by_hen_set<- data_wrangling(egg_prod, prod_type, n_egg_by_hen)
n_eggs_by_hen_set

test_stat <- diff(n_eggs_by_hen_set$n_egg_by_hen)
test_stat
```
...
generate_null_dist_plot(null_distribution, test_stat)
```
