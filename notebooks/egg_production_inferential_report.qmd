...
```{r, eda-summary, echo=FALSE, fig.cap="Table 1. EDA - Data Summary",message=FALSE, warning=FALSE}
summary <- readRDS("../results/summary.rds")
print(summary)
```

```{r, eda-str, echo=FALSE, fig.cap="Table 2. EDA - Data Structure",message=FALSE, warning=FALSE}
str <- readRDS("../results/str.rds")
print(str)
```

```{r, eda-head, echo=FALSE, fig.cap="Table 3. EDA - First Few Rows",message=FALSE, warning=FALSE}
# # head <- readRDS("../results/head.rds")
# # knitr::kable(head, caption = "EDA - First Few Rows") %>%
# #  kable_styling(full_width = FALSE)
```

```{r, eda-tail, echo=FALSE, fig.cap="Table 4. EDA - Last Few Rows", message=FALSE, warning=FALSE}

tail <- readRDS("../results/tail.rds")
knitr::kable(tail, caption = "EDA - Last Few Rows") %>%
  kable_styling(full_width = FALSE) 
```

```{r, eda-nrow, echo=FALSE, fig.cap="Table 5. EDA - Number of Rows", message=FALSE, warning=FALSE}
nrow <- readRDS("../results/nrow.rds")
knitr::kable(nrow, caption = "EDA - Number of Rows") %>%
  kable_styling(full_width = FALSE) 
...
```{r hist-n-eggs, fig.cap="Figure 1. EDA - Histogram of number of eggs", echo=FALSE}

knitr::include_graphics("../results/hist_n_eggs.png")

```

```{r hist-n-hens, fig.cap="Figure 2. EDA - Histogram of number of hens", echo=FALSE}

knitr::include_graphics("../results/hist_n_hens.png")
...
```{r bar-prod, fig.cap="Figure 3. EDA - Distribution of the production", echo=FALSE}

knitr::include_graphics("../results/bar_prod.png")

```

```{r bar-prod-process, fig.cap="Figure 4. EDA - Distribution of the production process", echo=FALSE}

knitr::include_graphics("../results/bar_prod_process.png")
...
knitr::kable(head(read_csv("../results/egg_prod.csv")), caption = "Data after Wrangling") |>
  kable_styling(full_width = FALSE) 
```
...
```{r data wrangling 2, echo=FALSE, fig.cap="Table 6.Summary of Number of Egg produced per hen by production", message=FALSE, warning=FALSE}
knitr::kable(head(read_csv("../results/data_wrangling.csv")), caption = "Summary of Number of Egg produced per hen by production") |>
  kable_styling(full_width = FALSE) 
```

```{r test stat, echo=FALSE, fig.cap="Table 7.Test Statistics for the two sample means", message=FALSE, warning=FALSE}
t_test <- readRDS("../results/test_stat.rds")
knitr::kable(t_test, caption = "Test Statistics for the two sample means") %>%
  kable_styling(full_width = FALSE) 
```
...
knitr::kable(head(read_csv("../results/null_distribution.csv")), caption = "Table 1. Null distribution generated from permutation") |>
  kable_styling(full_width = FALSE) 
```

```{r p-value, echo=FALSE, fig.cap="Table 8.P-value for Hypotheses Test", message=FALSE, warning=FALSE}
p_value <- readRDS("../results/p_value.rds")
knitr::kable(p_value, caption = "P-value for the permutation") %>%
  kable_styling(full_width = FALSE) 
```
...
```{r results-visualization, fig.cap="Figure 5. Results Visualization from null distribution of 1000 permutation with 5% significance level and test statistic", echo=FALSE}

knitr::include_graphics("../results/results_viz.png")
```
