...
```{r, eda-head, echo=FALSE, fig.cap="Table 2. EDA - First Few Rows",message=FALSE, warning=FALSE}
head <- readRDS("../results/head.rds")
knitr::kable(head, caption = "EDA - First Few Rows") %>%
 kable_styling(full_width = FALSE)
```

```{r, eda-tail, echo=FALSE, fig.cap="Table 3. EDA - Last Few Rows", message=FALSE, warning=FALSE}
...
```{r, eda-nrow, echo=FALSE, fig.cap="Table 4. EDA - Number of Rows", message=FALSE, warning=FALSE}
...
```{r data wrangling 2, echo=FALSE, fig.cap="Table 5.Summary of Number of Egg produced per hen by production", message=FALSE, warning=FALSE}
knitr::kable(head(read_csv("../results/data_wrangling.csv")), caption = "Summary of Number of Egg produced per hen by production") |>
  kable_styling(full_width = FALSE) 
```

```{r test stat, echo=FALSE, fig.cap="Table 6.Test Statistics for the two sample means", message=FALSE, warning=FALSE}
...
```{r p-value, echo=FALSE, fig.cap="Table 7.P-value for Hypotheses Test", message=FALSE, warning=FALSE}
