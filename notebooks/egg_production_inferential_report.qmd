...
In our research, we employed permutation tests to address our research questions. We chose permutation tests for several reasons. First, they offer a non-parametric alternative to traditional parametric tests such as t-tests. Unlike t-tests, permutation tests do not rely on specific distributional assumptions, making them suitable for various types of data. This flexibility is particularly advantageous when dealing with non-normally distributed or skewed datasets. Second, These permutation tests provide noteworthy advantages over their parametric counterparts for small samples and populations[@berry2011permutation]. They are highly adaptable and can be applied to a wide range of study designs.

However, it is essential to acknowledge that permutation tests have their own set of limitations and assumptions. One key assumption is the exchangeability of observations[@hayes1996permutation], meaning that any exchange of data points between groups is equally probable and independent. Additionally, the computational demands of permutation tests may increase significantly with large datasets or a high number of permutations. Despite these challenges, permutation tests offer a robust and versatile statistical approach that can yield meaningful insights while also addressing some of the drawbacks of traditional parametric methods.
